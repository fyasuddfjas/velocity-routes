    ...
    <section className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="absolute inset-0 route-grid opacity-10" />
          ...
          <div className="relative z-10 px-8 py-16 md:px-16 md:py-20 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to="/quote">
                <Button 
                  size="xl" 
                  className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-xl font-heading shadow-lg"
                >
              ...
              <Link to="/track">
                <Button 
                  variant="outline" 
                  size="xl"
                  className="border-2 border-secondary-foreground/30 text-secondary-foreground hover:bg-secondary-foreground/10 rounded-xl"
                >
